...
const Service = () => {
  return (
    <div className="bg-base_black">
      <div className="max-w-7xl mx-auto px-5 lg:px-10 my-16 gap-20 rounded-[40px] py-6 md:p-10 lg:p-14">
        <div className="flex flex-col md:flex-row justify-between gap-3 md:gap-16 items-center">
          ...
          <div className="hidden lg:block  w-fit h-fit rounded-full">
          ...
          <p className="text-base md:text-lg font-normal text-white md:flex-1">
            ...
            pengalaman dan keahlian yang mendalam, kami mampu menghadirkan
            produk digital berkualitas tinggi yang memenuhi kebutuhan Anda.
          </p>
        </div>
